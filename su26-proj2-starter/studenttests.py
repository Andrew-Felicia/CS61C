...
class TestAbsLoss(unittest.TestCase):
    ...
    def test_mixed_values(self):
        ...
        array0 = t.array([1, -2, 7, 4])
        array1 = t.array([3, -5, 7, 10])
        ...
        # Differences: -2, 3, 0, -6
        # Absolute values: 2, 3, 0, 6
        t.check_array(result, [2, 3, 0, 6])
...
class TestSquaredLoss(unittest.TestCase):
    def test_mixed_values(self):
        ...
        array0 = t.array([1, -2, 7])
        array1 = t.array([3, -5, 7])
