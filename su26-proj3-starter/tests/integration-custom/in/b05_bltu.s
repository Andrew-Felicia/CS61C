# Task 7: BLTU: equality, ordering, sign boundaries, both outcomes.
...
bltu t0, t1, case_1_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
...
bltu t0, t1, case_2_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
...
bltu t0, t1, case_3_end # TAKEN; offset +8 # EXPECT: TAKEN, offset +8
...
bltu t0, t1, case_4_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
...
bltu t0, t1, case_5_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: s0 = 0x0000001b
case_5_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x0000001b

# Case 6: 0x00000000 versus 0xffffffff.
addi t0, x0, 0 # EXPECT: t0 = 0x00000000
addi t1, x0, -1 # EXPECT: t1 = 0xffffffff
slli s0, s0, 1 # EXPECT: s0 = 0x00000036
bltu t0, t1, case_6_end # TAKEN; offset +8 # EXPECT: TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: SKIPPED on correct execution
case_6_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x00000036

# Case 7: 0xfffffffe versus 0xffffffff.
addi t0, x0, -2 # EXPECT: t0 = 0xfffffffe
addi t1, x0, -1 # EXPECT: t1 = 0xffffffff
slli s0, s0, 1 # EXPECT: s0 = 0x0000006c
bltu t0, t1, case_7_end # TAKEN; offset +8 # EXPECT: TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: SKIPPED on correct execution
case_7_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x0000006c

# Case 8: 0xffffffff versus 0xfffffffe.
addi t0, x0, -1 # EXPECT: t0 = 0xffffffff
addi t1, x0, -2 # EXPECT: t1 = 0xfffffffe
slli s0, s0, 1 # EXPECT: s0 = 0x000000d8
bltu t0, t1, case_8_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: s0 = 0x000000d9
case_8_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x000000d9
...
slli s0, s0, 1 # EXPECT: s0 = 0x000001b2
bltu t0, t1, case_9_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: s0 = 0x000001b3
case_9_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x000001b3
...
slli s0, s0, 1 # EXPECT: s0 = 0x00000366
bltu t0, t1, case_10_end # TAKEN; offset +8 # EXPECT: TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: SKIPPED on correct execution
case_10_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x00000366
...
slli t0, t0, 11 # EXPECT: t0 = 0x80000000
addi t1, x0, 1 # EXPECT: t1 = 0x00000001
slli s0, s0, 1 # EXPECT: s0 = 0x000006cc
bltu t0, t1, case_11_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: s0 = 0x000006cd
case_11_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x000006cd
...
slli t1, t1, 11 # EXPECT: t1 = 0x00100000
slli t1, t1, 11 # EXPECT: t1 = 0x80000000
slli s0, s0, 1 # EXPECT: s0 = 0x00000d9a
bltu t0, t1, case_12_end # TAKEN; offset +8 # EXPECT: TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: SKIPPED on correct execution
case_12_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x00000d9a
...
slli t1, t1, 11 # EXPECT: t1 = 0x00100000
slli t1, t1, 11 # EXPECT: t1 = 0x80000000
slli s0, s0, 1 # EXPECT: s0 = 0x00001b34
bltu t0, t1, case_13_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: s0 = 0x00001b35
case_13_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x00001b35
...
slli s0, s0, 1 # EXPECT: s0 = 0x0000366a
bltu t0, t1, case_14_end # TAKEN; offset +8 # EXPECT: TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: SKIPPED on correct execution
case_14_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x0000366a
...
slli s0, s0, 1 # EXPECT: s0 = 0x00006cd4
bltu t0, t1, case_15_end # NOT TAKEN; offset +8 # EXPECT: NOT TAKEN, offset +8
ori s0, s0, 1 # set the low signature bit only on fall-through # EXPECT: s0 = 0x00006cd5
case_15_end:
addi t2, s0, 0 # expose cumulative path signature # EXPECT: t2 = 0x00006cd5
