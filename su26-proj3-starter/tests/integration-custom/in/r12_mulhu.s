# Task 6: MULHU operand and boundary cases.
...
mulhu t2, t0, t1          # t2 = 0x0b00ea4e

# Destination aliases rs1, then rs2; consume each result immediately.
addi t0, x0, -7           # t0 = 0xfffffff9
addi t1, x0, 3            # t1 = 0x00000003
mulhu t0, t0, t1          # t0 = 0x00000002
addi s0, t0, 0            # s0 = 0x00000002
addi t0, x0, -7           # t0 = 0xfffffff9
addi t1, x0, 3            # t1 = 0x00000003
mulhu t1, t0, t1          # t1 = 0x00000002
addi s0, t1, 0            # s0 = 0x00000002

# Both read ports select the same source register.
addi t0, x0, -3           # t0 = 0xfffffffd
mulhu t2, t0, t0          # t2 = 0xfffffffa
